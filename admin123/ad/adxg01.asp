...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE adbiao SET adname01 = ?, addaima01 = ? WHERE id = ?" 
...
<form id="form1" name="form1" method="POST" action="<%=MM_editAction%>">
  <p>
    ...
    <input name="name" type="text" id="name" value="<%=(Recordset1.Fields.Item("adname01").Value)%>" />
    广告名称</p>
  <p>
    <label for="dm"></label>
    <textarea name="dm" id="dm" cols="45" rows="5"><%=(Recordset1.Fields.Item("addaima01").Value)%></textarea>
    广告代码</p>
  <p>
