<% 
const senlontitle="紫微斗数"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>紫微斗数在线排盘_实用查询工具大全 - Powered by Senlon!</TITLE>
...
<!--#include file="../senlon/jieqi.asp"-->
<!--#include file="../senlon/zwcom.asp"-->
...
<input type="radio" value="2" name="mode" />人盘
<input type="radio" value="3" name="mode" />地盘
<input type="radio" value="4" name="mode" />限流盘</td>
</tr>  <tr>
<td align="center" class="new"><input type="submit" value="紫微斗数在线排盘" name="submit" style="cursor:hand;" /> </td>
  ...
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" >
    <tbody>
      ...
      <tr>
        <td class="new"><p>紫微斗数，是中国传统命理学的最重要的支派之一。她是以人出生的年、月、日、时确定十二宫的位置，构成命盘，结合各宫的星群组合，牵系周易卦爻，来预测一个人的名员流程、吉凶祸福的。<BR><BR>相对于四柱推命而言，其渊源较早，而又是同源而分流,故并称为中国传统命理学的两大派别；而且紫微斗数推命术既具有道家宇宙观的神秘色彩，又具有注重社会环境、人际关系的近代意蕴，在中国神秘文化中卓立特出，名列“五大神数”之首，号称“天下第一神数”。<BR><BR>紫微斗数推命的出发点依然时天人合一的观念和阴阳五行的学说，但她在一般推命术的推算程序的基础上，以处于北天中央正宫的紫微垣中诸吉、凶、化星的尊卑位置特点及地球面对他们向背运动的规律，赋予不同的命理意义，以推知人的命运，因而具有自己的方法和特点。<BR><BR>紫微斗数推命术的基本方法时以一个人的出生年、月、日、时定出其命宫所在，依此推断其终生的地位、人格、贫富、休咎，然后依次列出兄弟宫、夫妻宫、子女宫、财帛宫、疾厄宫、迁移宫、交友宫、事业宫、田宅宫、福德宫、父母宫，作出生图；从而观察各宫位的星群组合，推知其斗数命理；最后再通过<strong>四化星</strong>（化科、化禄、化权、化忌）的牵引，注意各种变化的轨迹。<BR><BR>紫微斗数的明显特点是：<BR><BR>１、可将人的命运凶吉、贵贱休咎作出具体的说明，而非抽象的把握。<BR><BR>２、紫微斗数通过命盘十二宫，系统而全面的预测一个人一生的错综复杂的社会关系和个人遭遇，逻辑体系严密，既相对容易、程式化，又变化演绎，又较高的数理性和深刻性。<BR><BR>正因为如此，这种预测方法并非江湖上目不识丁的卜者或盲者可以掐指推算、信口开河的，在民间不如<strong>四柱</strong>流行，反过来讲，也正因为如此，紫微斗数才少了点庸俗性、玄虚性、迷信性，伴随着世界性的“易经热”、“命理热”、“信息预测热”的不断形成高潮，在现代文明程度较高的台、港、东南亚等地蔚然成风。<BR><BR>源流： <BR><BR>紫微斗数据传说大约是在北宋时期，由道家的一位重要人物陈抟（陈希夷）所发明。紫微斗数的前身是“十八飞星”，斗数略晚于五星术产生，大约与子平术（八字、四柱）同时，曾受到印度占星术的影响。历代研究斗数的著作相比大大少于八字，因此斗数源流和传承的情况，由于资料的缺乏而不太清晰。 <BR><BR>典籍： <BR><BR>由于斗数不如八字公开，研究斗数的人相对较少，留下的著作就更少。目前较为流行的斗数典籍是大约200年前的《斗数全书》与《斗数全集》，还有一些著名的赋文，如《太微赋》、《骨髓赋》等等。在一些港台现代人的斗数著作中，比较系统和规范的是民国时期陆斌兆的《紫微斗数讲义》、张开卷的《紫微斗数》和上个世纪90年代王亭之的《中州派紫微斗数》。紫微斗数在大陆一段时间以内由于各种原因曾经有过研究断层，随着改革开放的进行，一些港台术数家的斗数著作流入了大陆，极大的促进了大陆的紫微斗数研究的发展。 <BR></p>
</td>
      </tr>
  </table>
      <!--#INCLUDE FILE="../dq.asp"-->
