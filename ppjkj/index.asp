<% 
const senlontitle="金口诀在线排盘"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>金口诀在线排盘_实用查询工具大全 - Powered by Senlon!</TITLE>
...
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top">
	<div id="index">
<%if request("act")="ok" then%><!--#include file="../senlon/sizhu.asp"-->
...
<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" id="paipanTable">
  ...
  <B>节气</B>：<%=nextjq%> 
  <br>　　
  <strong>干支</strong>：<font color="#FF0000"> <%=ygz%>&nbsp;&nbsp;<%=mgz%>&nbsp;&nbsp;<%=dgz%>&nbsp;&nbsp;<%=tgz%></font><span class="ren">干支没有显示？</span><a href="http://sm.aa963.com/ppjkj/">点击这里重来&gt;&gt;</a>　　<strong>月将</strong>：<%=yuej%>将
  <br>　　
...
<td align="center" class="new"><input type="submit" value="在线八字排盘" name="submit" style="cursor:hand;" /> </td>
  ...
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" >
    <tbody>
      ...
      <tr>
        <td class="new"><p>提到金口诀就不可以不说大六壬，因为金口诀的全称就是&quot;大六壬神课金口诀&quot;。因此，可知金口诀是源于大六壬脱胎形成的新的一种预测科学。<br /><br />大六壬据传说源于上古九天玄女，但这毕竟只是传说。有史料记载的就是东汉赵晔《吴越春秋》，袁康《越绝书》均已有大六壬之文字，故由此可知大六壬应早于东汉时期出现。<br /><br />大六壬发展到战国时期，由阿鄄之间出生的伟大的军事家、玄学家孙膑简化而形成一门崭新的预测体系--&quot;大六壬神课金口诀&quot;，又有&quot;孙膑神课&quot;、&quot;小六壬&quot;、&quot;六壬时课&quot;等诸多别名。<br /><br />金口诀自孙膑创立后，在其传人后代中口口相传，不留文字，一直不为外人所知。我们现在可以看到的有关金口诀的著作最早的就是明朝时期的《大六壬神课金口诀》。这也是金口诀唯一的古版专著，但内容参差不齐，留下了几个时代的痕迹，并且篇张之间的距离感很强，由我推测应该不是一个人所著，此书应该是几个朝代的金口诀先师智慧的结晶。<br /><br />金口诀在孙膑之后的传承者们远离了政治舞台。以行卜为生，由于时代的久远，在传承上出现了一些不同的小支派，有的重口诀神煞，有的重旺相休囚，有的重年月日时对课内的影响等等，不一而同。这给金口诀的爱好者带来了许多的麻烦事，以致于到今天为止能全力研究金口诀的易学爱好者寥寥无几，更谈不上精通了。<br /><br />金口诀断课分为以下几种层次：<br /><br />第一种层次就是用口诀生搬硬套，简单的三动五动、大量的神煞，以及用月令日辰分出旺衰，这种断课方法是当前在金口诀界最多的断课技能，流传得最广，也是最简单的方法，应验率一般。<br /><br />第二层次，就是可以不用口诀、神煞，不用月令日辰的旺衰，可以灵活应用三动五动，准确地判断课内旺衰，大量地使用旺相休囚死配合用爻来判断事体，达到这种层次的人已经不多了，用这种方法断课准确率可迅速提升至令人惊汉的境界。<br /><br />第三层次，就是已经进入化境，对各种金口诀的理论精髓全部融会贯通，达到可以不用三动五动，不用旺相休囚死，只凭五行之间的生克来断事，这种层次已经是超越了金口诀的界限，可以灵活应用各种易术来给金口诀服务，说到底的一句话就是干支关系烂熟于心。<br /><br />以上三个层次就是当今金口诀界的现状，想提升层次又须要聚备扎实的基本功和敏于上进的心态和明师不断的循循善诱。具备了以上几点，学好用好金口诀就不是一件难事了。</p></td>
      </tr>
  </table>
      <!--#INCLUDE FILE="../dq.asp"-->
	</div>
