<% 
const senlontitle="观音灵签"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>观音灵签_实用查询工具大全 - Powered by Senlon!</TITLE>
...
</td></tr><tr><td class="new">观音解签：<%=jieqian%>
    <br><br><A href="./"><font color=red>点击这里返回抽签首页！</font></A> </td>
</tr><%else%>
...
<%
if gyclicknum="" then%>
<a href="?act=ok&gyclicknum=<%=gyclicknum+1%>&gyqid=<%=num%>" title="首先请您心无杂念，然后点这里开始擲出聖杯"><img src=../images/sign<%=picnum%>.gif width=100 height=77 border=0></a><br><br>需连续掷出三次圣杯，才是灵签！请点上面图标开始掷出圣杯<br>
<%else
randomize
gysmile=int((rnd*4)+1)
...
%><br>
<a href="?act=ok" title="首先请您心无杂念，然后点这里开始抽签"><img src="../images/qian.gif" width="97" height="189" border="0" /></a><DIV align="left" class="new2">
