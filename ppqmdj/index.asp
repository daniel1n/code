<% 
const senlontitle="奇门遁甲"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>奇门遁甲在线排盘_实用查询工具大全 - Powered by Senlon!</TITLE>
...
<br><strong>干支：</strong><%=ygz&"  "&mgz&"  "&dgz&"  "&tgz%><span class="ren">干支没有显示</span>？<a href="http://sm.aa963.com/ppqmdj/">点击这里重来&gt;&gt;</a><br>
<strong>当日旬空</strong>：<strong><%=yxunk%></strong>(年)&nbsp;<strong><%=mxunk%></strong>(月)&nbsp;<strong><%=rxunk%></strong>(日)&nbsp;<strong><%=txunk%></strong>(时)
<br>&nbsp;
