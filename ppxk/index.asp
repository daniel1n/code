<% 
const senlontitle="玄空飞星"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>玄空飞星在线排盘_实用查询工具大全 - Powered by Senlon!</TITLE>
...
Response.Cookies("ciduppsex")=sex
  ...
  tixing=0
%>
<!--#include file="../senlon/xkfunc.asp"-->
 ...
 <input type="submit" value="开始排盘" id=submit1 name=submit1>          　 
  ...
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" >
    <tbody>
      ...
      <tr>
        <td class="new"><p>玄就是时间，空就是空间，玄空学就是一门研究时间和空间为人造福的学问。玄空学由三大体系构成：河图，洛书，八卦。<BR><BR>河图必须要记忆的是：一六为水，二七为火，三八为木，四九为金，五十为土。河图为先天。洛书必须要记忆的是：戴九履一，左三右七，二四为肩，六八为足。洛书为后天。<BR>八卦有先天八卦，有后天八卦，先天配河图，后天配洛书。先后天八卦的方位一定要记牢。<BR><BR>关于河图洛书八卦的内容很多书籍都有了，我就不多说了，但大家要记住的是，这些是最重要的基础，一定要充分了解，否则后面的东西就很难掌握了。<BR><BR>在玄空风水中要用到的是：坎水为一居正北，坤土为二居西南，震木为三居正东，巽木为四居东南，五为土居正中，乾金为六居西北，艮土为八居东北，离火为九居正南。<BR><BR>玄空风水学在实践运用中的四的步骤是：一，排龙；二，安星；三，析局；四，调整。</p></td>
      </tr>
  </table>
      <!--#INCLUDE FILE="../dq.asp"-->
	</div>
