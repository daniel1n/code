<% 
const senlontitle="纳甲六爻在线排卦"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>纳甲六爻在线排卦_实用查询工具大全 - Powered by Senlon!</TITLE>

</head>
<body><!--#include file="../senlon/conn.asp"--><!--#include file="../senlon/getuc.asp"--><!--#include file="luner.js" -->
...
%>
<!--#include file="../senlon/xunkong.asp" -->
...
%>
      <B>旬　　空：</B><%= yxk%>&nbsp;&nbsp; <%= mxk%>&nbsp;&nbsp; <%= dxk%>&nbsp;&nbsp; <%=txk%>&nbsp;&nbsp;<span class="ren">旬空没有显示</span>？<a href="http://sm.aa963.com/pp6y/">点击这里重来&gt;&gt;</a>　<br>
...
<td align="center" class="new"><INPUT type=button value=确定排卦 name=ok onClick="javascript:getDate()" style="cursor:hand;" />&nbsp;&nbsp;&nbsp;&nbsp; <INPUT type=reset value=重新开始 name=re >  </td>
  ...
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" >
    <tbody>
      ...
      <tr>
        <td class="new">六爻是我国传统预测方法的一种，往往和八字等同论。叫六爻基本是民间普及的叫法，它的别名还有“火珠林预测”“纳甲预测”“周易预测”等，书本上多称之为周易预测。 <BR><BR>六爻所以叫六爻基本上是从形上叫来的。卦成后，它有六个爻位，由于动静不同的原因，变化也就很多了。易有六十四卦，一卦有六爻。卦因为爻动又分主和变等，所以六爻的演化的繁复是不逊于八字的。 <BR><BR>六爻成卦的方法也交多，在高手处更是随意而为。如：金钱起卦，以蓍草起卦，声音起卦，名字起卦，方位起卦等等，凡成有数，尽皆可为。起了卦能做什么？我们依照成卦的显示，从象理数占上入手，依爻与爻间的生克制化就能推算天地人间任何事物了（信否在您）。 </td>
      </tr>
  </table>
      <!--#INCLUDE FILE="../dq.asp"-->
	</div>
