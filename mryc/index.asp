<% 
const senlontitle="面热预测"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>面热预测_实用查询工具大全 - Powered by Senlon!</TITLE>
...
<tbody><tr>
  <td width="100%" class="ttd"><span class="red">面热预测:</span>
    <br><br>感觉脸如火在烧？热的不得了？不是感冒，又没发烧，为何脸会红？不能不知道！面热预测，告诉你面热征兆、面热吉凶、面热的原因，快来算算吧！<br><br></td>
</tr>
...
fx=request("fx")
stime=request("stime")
sql="select * from msyuce where stime='"&stime&"' and lb='面热'"
