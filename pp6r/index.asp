<% 
const senlontitle="六壬在线排盘"
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml"><head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<TITLE>六壬在线排盘_实用查询工具大全 - Powered by Senlon!</TITLE>
...
<td align="center" class="new"><input type="submit" value="六壬在线排盘" name="submit" style="cursor:hand;" /> </td>
  ...
  <table width="100%" border="0" align="center" cellspacing="0" cellpadding="0" class="b1" >
    <tbody>
      ...
      <tr>
        <td class="new">六壬是用阴阳五行占卜吉凶的一种术数。六壬与遁甲、太乙合称三式。五行以水为首，十天干中，壬、癸分别为阳水、阴水。舍阴取阳，六十甲子中壬有六个（壬申、壬午、壬辰、壬寅、壬子、壬戌），称为六壬。六壬有六十四课，以刻有干支的天盘、地盘相叠，转动天盘后得出所值的干支及时辰，判明吉凶。<BR><BR>六壬术起源很早，汉代《吴越春秋》、《越绝书》已有记载，《隋书·经籍志》载有《六壬式经杂古》《六壬释兆》。唐《王建诗·贫居》云：“近来身不健，时就六壬古。”说明在唐代时已经很流行六壬术。<BR><BR>《四库未收书提要》载录了宋代祝泌的《六壬大古》，并介绍云：“是编《宋志》不著录，郑樵《通志略》所列六壬，多至八十二家。焦宏《经籍志》凡八十九家，钱遵王《述古堂书目》凡一十八家，皆无是册，盖佚已久矣。此从宋刻本依样影抄，卷首有泌边书序及六壬起例。案泌云六壬立名，古今不宣其旨，惟《周礼·哲蔟氏》掌覆夭鸟之巢以方书十日、十二辰、十二月、十二岁、二十八星之号，即壬盘之体，三代之壬书，惟此一证，与术家以五行始于水，水生于一，成于六之说异。”<BR><BR>明代无名氏撰《六壬大全》，此书总汇六壬术诸家遗文，颇为详细，在社会上很有影响。<BR><BR>六壬术是易之支派，用于卜占，程序复杂，荒诞无稽，已经被历史所淘汰。<BR><BR>六壬是我国古典数术之一，与奇门、太乙并称为三式，因土为万物之母，水为万物之源，五行以水为一，且六十花甲子中六个壬故称为六壬。<BR><BR>其法以月将加时辰，立四课，排三传，观阴阳，辩生克，以决吉凶成败。<BR><BR>六壬以占卜人事著称，其法由来已久，具体年代，已无法确定，到了东汉已经盛行，由此已知定是始于汉代以前。<BR><BR>到了北宋，宋仁宗还亲为杨维德编撰的《景偌六壬神定经》作序。说明宋代时已经得到了社会各阶层的喜爱。这时的相关六壬书籍有徐次宾的《口鉴》，宋元改朝换代之际祝泌所著的《六壬大占》和《壬易会元》等书。<BR><BR>明代是中国数术蓬勃发展的时期，六壬类书籍更是层出不穷，其中以袁祥著，郭御青校刊的《六壬大全》、陈公献的《大六壬指南》、尹希吉的《六壬捷录》较为有名。<BR><BR>清代六壬专著更多，主要有徐端华的《六壬直指》等.<BR><BR>民国是文人研究数术成为时髦，这时的六壬类著作主要有韦千里的《千里秘笈》、袁树珊所著《大六壬探源》和徐养浩所著《大六壬金铰剪》等。<BR><BR>建国后由于历史原因，传统数术的研究一度中断。<BR><BR>改革开放以来，易学的春天再度来临，六壬作为一门传统学术，由于起点高，学习难度大，所以对六壬有较高造诣的的学者和能为之一读的六壬类专著却鲜为一见。<BR><BR>近代著作虽然有冯化成的《移神换将》、《六爻神探》，赵向阳的《推盘布局》，皆不如仙鹤居士的《实用六壬预测学》通俗易学，徐伟刚所著《袖里乾坤》阐微发隐，李峰注解的《御定六壬直指》可为一读。</td>
      </tr>
  </table>
      <!--#INCLUDE FILE="../dq.asp"-->
	</div>
